...
Incident management is not pure an IT issue, because incidents threaten an organization as a whole. Incident management seeks to both prevent incidents and to contain and resolve incidents that do happen in addition to learn from them. "Thus, incident management is an important tool of overall governance and to have it, in whatever form or shape, is a necessity." \cite{enisaGuide}
...
It is recommended that team members have diverse backgrounds so they may handle various problems. Teams should have appropriate access permissions, tools and training to be best prepared to conduct incident response. \cite{SANShandbook}
