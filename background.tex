...
\subsection{\acl{IRT}}
Despite extensive preparation and security implementations, incidents happen occasionally. Thus, organizations need incident response to mitigate damage caused by compromised personal and confidential information. Having an \ac{IRT} will aid organizations in responding to incidents more effectively and efficiently, in addition to providing a structured approach for learning from previous incidents. \ac{IRT} members, structure, tasks and responsibilities may vary depending on organizations' goals and needs for information security. 

Organizations should have an incident response team available to handle incidents. Large organizations may choose to have several incident response teams, e.g. one team per division. The structure of the team may vary depending on organizations' resources and needs. The team may be dedicated, virtual or a mix of the two. However, the ISO/IEC 27035 standard recommends a permanent team. Responsibilities, processes, allocation of roles and an appropriate training program should be prepared for the \ac{IRT}\cite{ISO/IEC27035}.

\ac{NIST} recommends having one person in charge of incident response, taking the role as team manager. The team manager should act as a liaison to senior management as well as ensuring that the team has the necessary resources, personnel and skills. 

It is recommended that team members have diverse backgrounds so they are eligible to handle different problems that may arise. Teams should have at least one member with experience in each major technological category. However, it is not required that all team members are technical experts. Nevertheless, good problem solving skills and communication skills are important since effective and efficient incidents response require collaboration and coordination throughout the team and the rest of the organization.

Often, \acp{IRT} have other responsibilities besides incident response, such as intrusion detection, advisory distribution, education and raising awareness\cite{nist800-61}. 

Teams should have appropriate access permissions, tools and training to be best prepared to conduct incident response \cite{SANShandbook}. 
