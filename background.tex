...
\subsection{NorSIS' Guidelines for Incident Management}
NorSIS has in cooperation with students\cite{sand2010hendelseshaandtering} developed a new guideline on incident management based on a survey documenting how Norwegian \ac{SMEs} do incident management.

\cite{norsisveiledning}
