...
It can be challenging to determine what information needs to be collected, how to obtain it and from where. Participants in this study pointed out that there are usually many sources of information which makes this difficult. 

Several of the participants in our study pointed out information dissemination as a challenge in incident handling. Knowing how much information to share can be difficult. Too little information could give an erroneous picture of the incident which could in turn lead to wrongs decisions being made or insufficient actions being taken. Too much information can be overwhelming and can cause delays in decision making as it has to be structured. It is important to communicate the \textit{right} information \textit{right} people. Information about incidents can obviously be quite sensitive and communicating such information to people who are not supposed to get it can have serious consequences.

An example of poor information dissemination from the employee survey in case B is that an employee stated that the information security policy is often changed without the employees being notified about the change.  

Awareness campaigns information. Not too much, not too little. "Ulv ulv"
...
\item \textit{failing to classify information can lead to the information not being sufficiently secured according to its value.}
\end{itemize}
\end{itemize}
...
Awareness campaigns. They are willing to learn! :)
