...
We also looked at related work and what have been studied earlier in the field of incident management. In these ways we used the background study to guide the data collection and we also used in in the data analysis, by comparing standards and prior developed theory. This is consistent with the definition of a case study, as presented in section \ref{sec:caseStudy}.
